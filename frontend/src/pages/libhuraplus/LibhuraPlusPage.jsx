    ...
    <div className="relative aspect-video overflow-hidden">
      ...
      {video.premium && !canWatch && (
        <div className="absolute inset-0 bg-dark-900/70 flex flex-col items-center justify-center gap-2">
          ...
          <span className="text-white/50 text-xs uppercase tracking-widest">Libhura+ Exclusive</span>
        </div>
      )}
      {(!video.premium || canWatch) && (
    ...
    <main className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="flex items-end justify-between mb-8">
        <div className="border-l-4 border-claret-800 pl-6">
          ...
          <h1 className="section-title">Libhura<span className="text-claret-400">+</span></h1>
        </div>
        {!isSubscriber && (
